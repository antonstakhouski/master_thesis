...
%    \fi
% }
\usepackage[sorting=none,backend=biber,defernumbers=true]{biblatex} % load the package
\addbibresource{bibliography_database.bib} % add a bib-reference file

\DeclareBibliographyCategory{AuthorSources}
\addtocategory{AuthorSources}{mol_uch,55_sntk}
