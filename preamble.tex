...
\makeatletter
\renewcommand\large{\@setfontsize\large{15pt}{18}} % 18 --- baseline skip in pt
\makeatother
...
% Зачем: Пункт 4.3.1 В конце заголовка пункта ставят точку
% TODO: не сделано. Нужно все менять на titlesec
%----------------------------------------------------------------------------------------
